...
socialLogin.factory("socialLoginService", ['$window', '$rootScope',
	function($window, $rootScope){
		return {
			logout: function(){
				console.log("social service logout ");
...
socialLogin.directive("gLogin", ['$rootScope', 'social', 'socialLoginService',
	function($rootScope, social, socialLoginService){
		console.log("inside google directive");
		return {
			restrict: 'EA',
			scope: {},
			replace: true,
			link: function(scope, ele, attr){
				ele.on('click', function(){
					var fetchUserDetails = function(){
						...
						console.log("basic profile of google user "+JSON.stringify(profile));
						return {
							token: accessToken,
							idToken: idToken, 
...
socialLogin.directive("fbLogin", ['$rootScope', 'social', 'socialLoginService', '$q',
	function($rootScope, social, socialLoginService, $q){
		console.log("inside fbLogin directive");
		return {
			restrict: 'EA',
			scope: {},
			replace: true,
